...
ctxts = {
    "income": {i: MetaType.REAL for i in range(14)},
    "synthetic": {i: MetaType.REAL for i in range(4)},
    "mnist": {i: MetaType.REAL for i in range(28 * 28)},
    "avazu": {i: MetaType.REAL for i in range(1, 26)},
    "credit": {i: MetaType.DISCRETE for i in range(5, 9)},
    "breast-cancer": {i: MetaType.REAL for i in range(30)},
    "baf": {i: MetaType.REAL for i in [0, 1, 5, 6, 9, 10, 11, 22, 25]},
}

ctxts["income"][14] = MetaType.BINARY
ctxts["income"][15] = MetaType.BINARY

ctxts["synthetic"][4] = MetaType.BINARY
...
feature_types = {
    "income": {i: "cont" for i in range(14)},
    "synthetic": {i: "cont" for i in range(4)},
    "mnist": {i: "cont" for i in range(28 * 28)},
    "avazu": {i: "cont" for i in range(1, 26)},
    "credit": {i: "ord" for i in range(5, 9)},
    "breast-cancer": {i: "cont" for i in range(30)},
}

feature_types["income"][14] = "cat"
feature_types["income"][15] = "cat"
feature_types["synthetic"][4] = "cat"
