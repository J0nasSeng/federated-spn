...
class FedSPNStrategy(fl.server.strategy.Strategy):
    ...
    def aggregate_fit(
        ...
        results = [(fit_res.parameters, fit_res.num_examples) for _, fit_res in results]
        ...
        save_image_stack(samples, 5, 5, img_path, margin_gray_val=0.0)
