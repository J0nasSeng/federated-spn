...
from ceinsum.Layer import Layer
import functools
...
class SumLayer(Layer):
    ...
    def _backtrack(
        self, dist_idx, node_idx, sample_idx, params, use_evidence=False, mode="sample"
    ):
        """
    ...
    def backtrack(
        self, params, dist_idx, node_idx, sample_idx, use_evidence=False, mode="sample"
    ):
        """
        ...
        return self._backtrack(
            dist_idx, node_idx, sample_idx, params, use_evidence, mode
        )
